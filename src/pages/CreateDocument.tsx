  ...
  const renderFormField = (section: any) => {
    ...
    switch (section.type) {
      ...
      case 'service-activities':
        ...
        const serviceEvents = Array.isArray(service.eventi) ? service.eventi : [];
        return (
          <div className="space-y-4">
            <div>
            ...
            <div>
              <Label className="text-sm font-semibold">Eventi e Progetti Specifici</Label>
              {serviceEvents.map((event, index) => (
                <Card key={index} className="p-4 mt-2">
                  <div className="flex justify-between items-start mb-3">
                    <h4 className="font-medium text-sm">Evento/Progetto {index + 1}</h4>
                    <Button
                      variant="ghost"
                      size="sm"
                      onClick={() => {
                        const updatedEvents = serviceEvents.filter((_, i) => i !== index);
                        updateContent(section.key, { ...service, eventi: updatedEvents });
                      }}
                    >
                      <X className="w-4 h-4" />
                    </Button>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div>
                      <Label className="text-xs">Nome Evento/Progetto *</Label>
                      <Input
                        value={event.nome || ''}
                        onChange={(e) => {
                          const updatedEvents = [...serviceEvents];
                          updatedEvents[index] = { ...event, nome: e.target.value };
                          updateContent(section.key, { ...service, eventi: updatedEvents });
                        }}
                        placeholder="Nome evento o progetto"
                        className="mt-1"
                      />
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => {
                          const updatedEvents = [...serviceEvents];
                          updatedEvents[index] = { ...event, ora: e.target.value };
                          updateContent(section.key, { ...service, eventi: updatedEvents });
                        }}
                        className="mt-1"
                      />
                  ...
                  <div className="mt-3">
                    ...
                    <Textarea
                      ...
                      placeholder="Descrizione dell'evento o progetto"
                      rows={2}
                      className="mt-1"
                    />
                  </div>
              ...
              <Button
                ...
                onClick={() => {
                  ...
                  updateContent(section.key, { ...service, eventi: [...serviceEvents, newEvent] });
                }}
                className="w-full mt-2"
              >
                <Plus className="w-4 h-4 mr-2" />
                Aggiungi Evento/Progetto
              </Button>
            </div>
          </div>
        );
      case 'club-communications':
        ...
        const clubCommEvents = Array.isArray(clubComm.eventi) ? clubComm.eventi : [];
        return (
          <div className="space-y-4">
            <div>
            ...
            <div>
              <Label className="text-sm font-semibold">Eventi e Comunicazioni Specifiche</Label>
              {clubCommEvents.map((event, index) => (
                <Card key={index} className="p-4 mt-2">
                  <div className="flex justify-between items-start mb-3">
                    <h4 className="font-medium text-sm">Evento/Comunicazione {index + 1}</h4>
                    <Button
                      variant="ghost"
                      size="sm"
                      onClick={() => {
                        const updatedEvents = clubCommEvents.filter((_, i) => i !== index);
                        updateContent(section.key, { ...clubComm, eventi: updatedEvents });
                      }}
                    >
                      <X className="w-4 h-4" />
                    </Button>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div>
                      ...
                      <Input
                        value={event.nome || ''}
                        onChange={(e) => {
                          const updatedEvents = [...clubCommEvents];
                          updatedEvents[index] = { ...event, nome: e.target.value };
                          updateContent(section.key, { ...clubComm, eventi: updatedEvents });
                        }}
                        placeholder="Nome evento o comunicazione"
                        className="mt-1"
                      />
                    </div>
                    <div>
                  ...
                  <div className="mt-3">
                    ...
                    <Textarea
                      ...
                      placeholder="Descrizione dell'evento o comunicazione"
                      rows={2}
                      className="mt-1"
                    />
                  </div>
              ...
              <Button
                ...
                onClick={() => {
                  ...
                  updateContent(section.key, { ...clubComm, eventi: [...clubCommEvents, newEvent] });
                }}
                className="w-full mt-2"
              >
                <Plus className="w-4 h-4 mr-2" />
                Aggiungi Evento/Comunicazione
              </Button>
            </div>
          </div>
        );
      case 'district-agenda':
        ...
        const districtEvents = Array.isArray(district.eventi) ? district.eventi : [];
        return (
          <div className="space-y-4">
            <div>
            ...
            <div>
              <Label className="text-sm font-semibold">Eventi Distrettuali Specifici</Label>
                ...
                <Card key={index} className="p-4 mt-2">
                  <div className="flex justify-between items-start mb-3">
                    ...
                    <Button
                      ...
                      size="sm"
                      onClick={() => {
                        const updatedEvents = districtEvents.filter((_, i) => i !== index);
                        updateContent(section.key, { ...district, eventi: updatedEvents });
                      }}
                    >
                      <X className="w-4 h-4" />
                    </Button>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div>
                      ...
                      <Input
                        value={event.nome || ''}
                        onChange={(e) => {
                          const updatedEvents = [...districtEvents];
                          updatedEvents[index] = { ...event, nome: e.target.value };
                          updateContent(section.key, { ...district, eventi: updatedEvents });
                        }}
                        placeholder="Nome evento distrettuale"
                        className="mt-1"
                      />
                    </div>
                    <div>
                  ...
                  <div className="mt-3">
                    ...
                    <Textarea
                      ...
                      placeholder="Descrizione dell'evento distrettuale"
                      rows={2}
                      className="mt-1"
                    />
                  </div>
              ...
              <Button
                ...
                onClick={() => {
                  ...
                  updateContent(section.key, { ...district, eventi: [...districtEvents, newEvent] });
                }}
                className="w-full mt-2"
              >
                <Plus className="w-4 h-4 mr-2" />
      ...
      case 'motivational-section':
        ...
        const motivationalEvents = Array.isArray(motivational.eventi) ? motivational.eventi : [];
        return (
          <div className="space-y-4">
            <div>
            ...
            <div>
              <Label className="text-sm font-semibold">Eventi Culturali Specifici</Label>
              {motivationalEvents.map((event, index) => (
                <Card key={index} className="p-4 mt-2">
                  <div className="flex justify-between items-start mb-3">
                    <h4 className="font-medium text-sm">Evento Culturale {index + 1}</h4>
                    <Button
                      variant="ghost"
                      size="sm"
                      onClick={() => {
                        const updatedEvents = motivationalEvents.filter((_, i) => i !== index);
                        updateContent(section.key, { ...motivational, eventi: updatedEvents });
                      }}
                    >
                      <X className="w-4 h-4" />
                    </Button>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div>
                      ...
                      <Input
                        value={event.nome || ''}
                        onChange={(e) => {
                          const updatedEvents = [...motivationalEvents];
                          updatedEvents[index] = { ...event, nome: e.target.value };
                          updateContent(section.key, { ...motivational, eventi: updatedEvents });
                        }}
                        placeholder="Nome evento culturale"
                        className="mt-1"
                      />
                    </div>
                    <div>
                  ...
                  <div className="mt-3">
                    ...
                    <Textarea
                      ...
                      placeholder="Descrizione dell'evento culturale"
                      rows={2}
                      className="mt-1"
                    />
                  </div>
              ...
              <Button
                ...
                onClick={() => {
                  ...
                  updateContent(section.key, { ...motivational, eventi: [...motivationalEvents, newEvent] });
                }}
                className="w-full mt-2"
              >
                <Plus className="w-4 h-4 mr-2" />
                Aggiungi Evento Culturale
              </Button>
            </div>
          </div>
        );
