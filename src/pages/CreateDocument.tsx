...
export default function CreateDocument() {
  ...
  const downloadPDF = async () => {
    try {
      ...
      const rotaryYearValue = formData.content['anno_rotariano'] ? `A.R. ${formData.content['anno_rotariano'].replace('2025 - 2026', '25/26')}` : null;
        ...
        pdfContent += `
          <div style="margin-bottom: 24px;">
            <div style="text-align: center; border-bottom: 1px solid #e5e7eb; padding-bottom: 16px;">
              <h1 style="font-size: 24px; font-weight: bold; margin: 0 0 8px 0;">Programma Mensile - ${meseCapitalized} - 2025 - 2026</h1>
                        ...
                        <div className="flex justify-center items-center gap-4 flex-wrap">
                          ...
                          {formData.content['anno_rotariano'] && (
                            <span className="text-sm font-medium text-primary bg-primary/10 px-3 py-1 rounded-full border border-primary/20">
                              A.R. {formData.content['anno_rotariano'].replace('2025 - 2026', '25/26')}
                            </span>
                          )}
                        </div>
                      </div>
                           ...
                           {formData.type === 'programmi' ? (
                            <>
                              <h1 className="text-2xl font-bold">
                                Programma Mensile - {formData.content['mese'] ? formData.content['mese'].charAt(0).toUpperCase() + formData.content['mese'].slice(1) : 'Settembre'} - 2025 - 2026
                              </h1>
                            </>
                          ) : (
                           <>
