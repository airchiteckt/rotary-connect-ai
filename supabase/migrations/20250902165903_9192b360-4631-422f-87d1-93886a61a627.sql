...
-- Insert the district events
INSERT INTO public.district_events (user_id, nome, luogo, giorno, mese, giorni_consecutivi, descrizione) VALUES
-- Use a placeholder user_id for now - this will need to be updated per user
(auth.uid(), 'Seminario Immagine Pubblica e Comunicazione', 'Benevento', NULL, NULL, 1, 'Seminario Immagine Pubblica e Comunicazione'),
(auth.uid(), 'Domenica della Salute', 'Benevento', 21, NULL, 1, 'Domenica della Salute'),
(auth.uid(), 'Institute Europa - Medio Oriente - Africa', 'Bruxelles', 25, NULL, 4, 'Institute Europa - Medio Oriente - Africa (25, 26, 27 e 28)');
